...
@endsection
@section('content')
<form method="POST" action="/data-guru/edit/{{ $data->id }}" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <section id="tambah-data-guru">
        <div class="container px-4 bg-light" style="margin-top: 70px">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    <h2 style="text-align: center;">Edit Data Pengajar</h2>
                    ...
                    <div class="my-4">
                        ...
                        <img class="image mt-3" src="{{ asset('storage/'.$data->foto) }}" alt="" style="height: 250px;width:250px;">
                    </div>
